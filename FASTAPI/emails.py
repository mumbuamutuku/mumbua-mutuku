...
conf = ConnectionConfig(
    ...
    MAIL_STARTTLS = True,  # or False, depending on your email service
    MAIL_SSL_TLS = False,   # or False, depending on your email service
...
async def send_email(email : list, instance: User):
    ...
    template = f"""
        ...
        <body>
            <div style=" display: flex; align-items: center; justify-content: center; flex-direction: column;">
                ...
                <br>
                <p>Thanks for choosing Print & Copy Stores, please 
                ...
                <p style="margin-top:1rem;">If you did not register for Print & Copy Stores, 
    ...
    message = MessageSchema(
        subject="Print Copy Solution Store Account Verification Mail",
